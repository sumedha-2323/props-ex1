    ...
    <section className="posts-container">
     {
      data.map((eachObj)=>{
        return(
          <Profile key={eachObj.id} id={eachObj.id} title={eachObj.title} url={eachObj.url} thumbnail={eachObj.thumbnailUrl}/>
        )
      })
     }
    </section>
...
// instead of writing profile component in this, we can also 
// write in another js file an import into this.
export default App;
